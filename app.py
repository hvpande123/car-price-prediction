...
def main():
    ...
    if option == 'About':
        ...
        html_temp_contact = """
                    ...
                    <div style = "background color:#D7C49EFF; padding:10px">
                    <p>This Model is Developed by <b>Harshvardhan Pande</b></p>
                    <p>LinkedIn: <a href="https://www.linkedin.com/in/harshvardhan-pande-9619061aa/">Link</a></p>
                    <p>Leetcode: <a href="https://leetcode.com/harshvp21/">Link</a></p>
                    <p>JAI HIND</p>
                    </div>"""
